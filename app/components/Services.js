        ...
        <details>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Biofeedback to nowoczesna i bezpieczna metoda treningowa, która
              uczy świadomej regulacji pracy organizmu, w szczególności układu
              nerwowego. Dzięki informacji zwrotnej otrzymywanej w czasie
              rzeczywistym możliwe jest realne wpływanie na koncentrację, poziom
              stresu, wyciszenie oraz relaksację.
            </p>
            <p className="text-gray-700 mb-4 leading-relaxed">
              Podczas treningu osoba ćwicząca otrzymuje czytelne sygnały
              pokazujące, jak funkcjonuje jej organizm – m.in. mózg, mięśnie,
              rytm serca czy reakcje skórne. Informacje te przedstawiane są w
              przyjaznej formie, często jako gra komputerowa, co zwiększa
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              zwrotnego. Oznacza to, że reakcja organizmu wpływa na sygnał,
              który ją wywołał – wzmacniając lub osłabiając określone procesy.
            </p>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              istniejących, co przekłada się na poprawę funkcjonowania w
              codziennym życiu.
            </p>
            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Biofeedback nie jest bierną terapią. Skuteczność treningu opiera
              się na aktywnym zaangażowaniu osoby ćwiczącej. Poprzez
              koncentrację, sposób myślenia i regulację emocji osoba uczy się
              wpływać na przebieg treningu i własne reakcje.
            </p>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              sprzyjają wydzielaniu neuroprzekaźników (m.in. dopaminy i
              serotoniny), które wspierają proces uczenia się oraz stabilizację
              układu nerwowego.
            </p>
            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">
            ...
            <ul className="list-disc list-inside text-gray-700 mb-4">
              <li>
                Neurofeedback (EEG Biofeedback) – związany z aktywnością
                ośrodkowego układu nerwowego: EEG Biofeedback, HEG Biofeedback
              </li>
              <li>
                Biofeedback obwodowy: GSR / SCL – reakcja skórno-galwaniczna
              </li>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Biofeedback jest przeznaczony dla dzieci od 5. roku życia,
              młodzieży oraz osób dorosłych. Poprawa funkcjonowania układu
              nerwowego wpływa pozytywnie na rozwój emocjonalny, poznawczy i
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Biofeedback to metoda: nieinwazyjna, całkowicie bezpieczna,
